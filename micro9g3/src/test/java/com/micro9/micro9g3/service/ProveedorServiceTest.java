...
class ProveedorServiceTest {
    ...
    void testGuardarProveedor() {
        Proveedor proveedor = new Proveedor(1,"Proveedor","11.111.111-1","Av. Siempre Viva 123","912345678","proveedor@correo.com",null
        );

        Proveedor proveedorGuardado = new Proveedor(1,"Proveedor","11.111.111-1","Av. Siempre Viva 123","912345678","proveedor@correo.com",null
        );
        ...
        assertThat(resultado.getNombreProveedor()).isEqualTo("Proveedor");
